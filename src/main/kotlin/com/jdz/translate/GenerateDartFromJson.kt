...
class GenerateDartFromJson : AnAction() {
    ...
    private fun generateTranslateManagerDartClass(
        ...
        bufferedWriter.newLine()
        bufferedWriter.write("  static String _currentLanguageCode=\"zh\";")
        bufferedWriter.newLine()
        bufferedWriter.write("  String get currentLanguageCode=>_currentLanguageCode;")
        bufferedWriter.newLine()
        bufferedWriter.newLine()
        ...
        bufferedWriter.newLine()
        bufferedWriter.write("    _currentLanguageCode=languageCode;")
        bufferedWriter.newLine()
